...
# Import Routers
from app.routes import machines, sensors, health, prediction, alerts, analytics, maintenance, settings, telemetry
...
app.include_router(telemetry.router, prefix=config.API_PREFIX)
